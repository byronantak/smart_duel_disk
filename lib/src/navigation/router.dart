...
import 'package:smart_duel_disk/packages/features/feature_settings/lib/src/widgets/settings_screen_provider.dart';
  ...
  routes: <AutoRoute>[
    AutoRoute<void>(
      ...
      children: [
        ...
        AutoRoute<void>(name: 'SettingsTab', page: SettingsScreenProvider),
      ],
    ),
