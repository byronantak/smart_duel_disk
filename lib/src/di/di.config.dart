...
import '../../packages/core/core_data_manager/core_data_manager_interface/lib/core_data_manager_interface.dart'
    as _i41;
import '../../packages/core/core_general/lib/core_general.dart' as _i72;
...
import '../../packages/core/core_storage/core_storage_interface/lib/core_storage_interface.dart'
    as _i34;
import '../../packages/core/core_user_settings/core_user_settings_impl/lib/src/user_settings_data_manager_impl.dart'
    as _i52;
import '../../packages/core/core_user_settings/core_user_settings_impl/lib/src/user_settings_storage_provider_impl.dart'
    as _i31;
import '../../packages/core/core_user_settings/core_user_settings_interface/lib/core_user_settings_interface.dart'
    as _i30;
...
import '../../packages/features/feature_home/lib/src/news/news_viewmodel.dart'
    as _i71;
import '../../packages/features/feature_settings/lib/src/settings_viewmodel.dart'
    as _i62;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i30.UserSettingsStorageProvider>(() =>
      _i31.UserSettingsStorageProviderImpl(
          get<_i19.SharedPreferencesProvider>()));
  ...
  gh.lazySingleton<_i34.DuelStorageProvider>(() =>
      _i43.DuelStorageProviderImpl(get<_i19.SharedPreferencesProvider>()));
  gh.lazySingleton<_i44.Logger>(() =>
      _i45.LoggerImpl(get<_i38.CrashlyticsProvider>(), get<_i25.AppConfig>()));
  ...
  gh.lazySingleton<_i30.UserSettingsDataManager>(() =>
      _i52.UserSettingsDataManagerImpl(
          get<_i30.UserSettingsStorageProvider>()));
  gh.factoryParam<_i53.YugiohCardDetailViewModel, _i41.YugiohCard, int>(
      (_yugiohCard, _index) => _i53.YugiohCardDetailViewModel(
          get<_i44.Logger>(), _yugiohCard, _index));
  gh.lazySingleton<_i54.CreatePlayCardDialogActionsUseCase>(
      () => _i54.CreatePlayCardDialogActionsUseCase(get<_i44.Logger>()));
  gh.factory<_i55.DeckViewModel>(() => _i55.DeckViewModel(get<_i44.Logger>(),
      get<_i47.RouterHelper>(), get<_i56.SnackBarService>()));
  gh.lazySingleton<_i57.Dio>(() => ygoProDeckModule.provideYgoProDeckDio(
      get<_i25.AppConfig>(), get<_i44.Logger>()));
  gh.lazySingleton<_i41.DuelDataManager>(
      () => _i58.DuelDataManagerImpl(get<_i34.DuelStorageProvider>()));
  gh.factoryParam<_i59.PlayCardDialogViewModel, _i60.PlayCard, _i61.Zone>(
      (_playCard, _newZone) => _i59.PlayCardDialogViewModel(
          _playCard,
          _newZone,
          get<_i54.CreatePlayCardDialogActionsUseCase>(),
          get<_i47.DialogService>(),
          get<_i17.Logger>()));
  gh.factory<_i62.SettingsViewModel>(() => _i62.SettingsViewModel(
      get<_i17.Logger>(), get<_i30.UserSettingsDataManager>()));
  gh.lazySingleton<_i63.YgoProDeckRestClient>(
      () => _i63.YgoProDeckRestClient(get<_i57.Dio>()));
  gh.lazySingleton<_i64.YgoProDeckApiProvider>(
      () => _i65.YgoProDeckApiProviderImpl(get<_i63.YgoProDeckRestClient>()));
  gh.lazySingleton<_i41.YugiohCardsDataManager>(() =>
      _i66.YugiohCardsDataManagerImpl(get<_i64.YgoProDeckApiProvider>(),
          get<_i34.YugiohCardsStorageProvider>()));
  gh.lazySingleton<_i41.DataManager>(() => _i67.DataManagerImpl(
      get<_i41.NewsDataManager>(),
      get<_i41.YugiohCardsDataManager>(),
      get<_i41.DeckDataManager>(),
      get<_i41.DuelDataManager>()));
  gh.factoryParam<_i68.DeckBuilderViewModel, _i41.PreBuiltDeck, dynamic>(
      (_preBuiltDeck, _) => _i68.DeckBuilderViewModel(get<_i44.Logger>(),
          _preBuiltDeck, get<_i47.RouterHelper>(), get<_i41.DataManager>()));
  gh.factory<_i69.DuelViewModel>(() => _i69.DuelViewModel(
      get<_i44.Logger>(),
      get<_i11.DuelFormValidators>(),
      get<_i47.RouterHelper>(),
      get<_i41.DataManager>()));
  gh.lazySingleton<_i70.GetCardsFromDeckUseCase>(() =>
      _i70.GetCardsFromDeckUseCase(
          get<_i41.DataManager>(), get<_i40.CreatePlayCardUseCase>()));
  gh.factory<_i71.NewsViewModel>(() => _i71.NewsViewModel(
      get<_i44.Logger>(),
      get<_i47.RouterHelper>(),
      get<_i41.DataManager>(),
      get<_i72.DateFormatter>(),
  ...
  gh.factoryParam<_i76.SpeedDuelViewModel, _i41.PreBuiltDeck, dynamic>(
      (_preBuiltDeck, _) => _i76.SpeedDuelViewModel(
          get<_i44.Logger>(),
          _preBuiltDeck,
          get<_i47.RouterHelper>(),
          get<_i73.SmartDuelServer>(),
          get<_i70.GetCardsFromDeckUseCase>(),
          get<_i40.CreatePlayCardUseCase>(),
          get<_i9.DoesCardFitInZoneUseCase>(),
          get<_i41.DataManager>(),
          get<_i12.EnumHelper>(),
          get<_i38.CrashlyticsProvider>(),
          get<_i56.SnackBarService>(),
          get<_i30.UserSettingsDataManager>()));
  gh.factory<_i32.WebSocketProvider>(
      () => _i77.WebSocketProviderImpl(get<_i75.Socket>(), get<_i44.Logger>()));
  return get;
}
