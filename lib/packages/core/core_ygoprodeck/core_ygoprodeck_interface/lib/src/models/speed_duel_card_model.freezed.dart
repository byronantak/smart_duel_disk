...
class _$_SpeedDuelCardModel implements _SpeedDuelCardModel {
  ...
  @override
  String toString() {
    return 'SpeedDuelCardModel(id: $id, name: $name, type: $type, desc: $desc, race: $race, cardImages: $cardImages, cardPrices: $cardPrices, atk: $atk, def: $def, level: $level, attribute: $attribute, archetype: $archetype, banListInfo: $banListInfo)';
  }
